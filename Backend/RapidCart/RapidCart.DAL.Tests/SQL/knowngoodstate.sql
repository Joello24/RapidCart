...
BEGIN
    ...
    insert into Item (CategoryId, [Name], [Description], Price, Inventory, [Path]) values (7, 'Beef Rib Eye', 'nunc donec', 51.34, 66, 'ribEye.jpeg');
    insert into Item (CategoryId, [Name], [Description], Price, Inventory, [Path]) values (2, 'Choclate Cake', 'nam congue', 96.42, 49, 'chocolateCake.jpeg');
    insert into Item (CategoryId, [Name], [Description], Price, Inventory, [Path]) values (8, 'Lettuce', 'libero non mattis pulvinar nulla', 19.88, 52, 'lettuce.jpeg');
    insert into Item (CategoryId, [Name], [Description], Price, Inventory, [Path]) values (8, 'Eggplant', 'volutpat', 77.61, 24, 'eggplant.jpeg');
    insert into Item (CategoryId, [Name], [Description], Price, Inventory, [Path]) values (5, 'Olive Oil', 'ut nunc vestibulum', 20.02, 54, 'oliveOil.jpeg');
    insert into Item (CategoryId, [Name], [Description], Price, Inventory, [Path]) values (4, 'American Cheese', 'massa quis augue luctus tincidunt', 13.75, 72, 'americanCheese.jpeg');
    insert into Item (CategoryId, [Name], [Description], Price, Inventory, [Path]) values (7, 'Cod Fillet', 'nullam sit amet', 74.84, 98, 'codFillet.jpeg');
    insert into Item (CategoryId, [Name], [Description], Price, Inventory, [Path]) values (1, 'Carbonated Water - Blackberry', 'ac tellus semper', 90.42, 32, 'carbonatedWater.jpeg');
    insert into Item (CategoryId, [Name], [Description], Price, Inventory, [Path]) values (1, 'Canada Dry', 'nec sem duis aliquam', 2.28, 94, 'canadaDry.jpeg');
    insert into Item (CategoryId, [Name], [Description], Price, Inventory, [Path]) values (1, 'Wine', 'et eros vestibulum ac', 31.79, 7, 'wine.jpeg');
